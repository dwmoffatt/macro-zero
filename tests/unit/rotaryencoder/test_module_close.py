...
class TestModuleInit:
    ...
    def test_module_close(self):
        """
        Tests that rotary encoder module_close runs correctly
        Requires init'ing the module first
        :return:
        """
        self.app.mode_select_rotary_encoder.module_init()
        result = self.app.mode_select_rotary_encoder.module_close()
